...
from schemas import PostCreate, PostResponse, UserCreate, UserBase, UserResponse, UserUpdate, PostUpdate
...
#user annoted has used dependency injection get_db creates sessions and flushed once not longer in user
